...
6. Optimizes Pi Zero 2W settings (GPU memory, swap)
...
**Issue:** Pi touchscreen not responding
- Check kiosk mode config
- Verify Chromium is running: `ps aux | grep chromium`
- Restart X server: `sudo systemctl restart lightdm`
